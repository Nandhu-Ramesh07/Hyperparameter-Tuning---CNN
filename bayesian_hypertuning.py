...
tuner = BayesianOptimization(
    ...
    num_initial_points=3,  # Optional initial points for exploration
    alpha=1e-4,  # Adjust the exploration hyperparameter
    beta=2.6,  # Adjust the exploitation hyperparameter
)
